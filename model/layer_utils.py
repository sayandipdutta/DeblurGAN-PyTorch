...
model = models.VGG(make_layers(cfgs['E']))#, batch_norm=batch_norm))
CONV3_3_IN_VGG_19 = model.load_state_dict(torch.load('/home/sayandip199309/GitProjects/DeblurGAN-pytorch-master/model/vgg19-dcbb9e9d.pth'))
